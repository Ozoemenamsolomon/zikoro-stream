      ...
      <div className="w-fit h-fit m-auto inset-0 absolute flex flex-col gap-y-2 items-center justify-center px-4">
        ...
        <div className="w-full max-w-xl flex flex-col items-center justify-center gap-y-3">
          ...
          <Button
            ...
            type="submit"
            onClick={verify}
            className="bg-basePrimary gap-x-2 text-gray-50 mt-3  font-medium flex items-center justify-center w-full  h-11 rounded-lg"
          >
            {isVerifying && <Loader2Icon size={22} className="animate-spin" />}
          ...
          <div className={cn("block w-full space-y-3")}>
            <div className="flex w-full justify-center items-center gap-x-2">
              ...
              <Button
                ...
                className={cn(
                  "hidden text-base px-2 hover:underline w-fit font-semibold",
                  secondsLeft <= 0 && "flex"
                )}
              >
                Resend
